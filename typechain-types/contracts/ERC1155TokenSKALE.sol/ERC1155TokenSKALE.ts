...
export interface ERC1155TokenSKALEInterface extends utils.Interface {
  functions: {
    ...
    "bridgeToETH(address,address,uint256,uint256,bytes)": FunctionFragment;
...
export interface ERC1155TokenSKALE extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC1155TokenSKALEInterface;
